...
:::note
Our documentation about custom extensions in general leaves a lot to be desired, especially for [unsandboxed extensions](unsandboxed-extensions). We know. We're working on it. **New documentation is in the process of being written.**
:::
